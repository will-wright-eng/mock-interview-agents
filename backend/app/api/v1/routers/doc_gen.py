...
async def generate_questions_and_rubric(request: Request):
    ...
    # Save submission data to a file in the uploads folder
    submission_data = {
        "udid": udid,
        "job_title": job_title,
        "cv": cv
    }
    with open(f"uploads/{udid}.json", "w") as submission_file:
    ...
    # Save generated questions to a file in the questions folder
    questions_data = {
        "udid": udid,
        "questions": questions
    }
    with open(f"questions/{udid}.json", "w") as questions_file:
        json.dump(questions_data, questions_file)

    return {"questions": questions, "udid": udid}
